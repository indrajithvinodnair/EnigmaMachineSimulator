...
<section class="columns">
  <div class="column reflector">
    ...
    <span class="select">
      <select name="reflector" v-model="reflector" @change="selectReflector" :disabled="uiState.isInputDisabled">
  ...
  <div class="column rotor rotor-left">
    ...
    <div class="rotor-position is-flex is-flex-direction-column is-align-items-center is-justify-content-space-evenly mt-3">
      ...
      <span class="select">
        <select name="position" v-model="state.rotors.LEFT.position" :disabled="uiState.isInputDisabled">
  ...
  <div class="column rotor rotor-middle">
    ...
    <div class="rotor-position is-flex is-flex-direction-column is-align-items-center is-justify-content-space-evenly mt-3">
      ...
      <span class="select">
        <select name="position" v-model="state.rotors.MIDDLE.position" :disabled="uiState.isInputDisabled">
          <option v-for="letter in ALLOWED_ALPHABET" :value="toAlphabetIndex(letter)">{{letter.toUpperCase()}}</option>
        </select>
      </span>
  ...
  <div class="column rotor rotor-right">
    ...
    <div class="rotor-position is-flex is-flex-direction-column is-align-items-center is-justify-content-space-evenly mt-3">
      ...
      <span class="select">
        <select name="position" v-model="state.rotors.RIGHT.position" :disabled="uiState.isInputDisabled">
          <option v-for="letter in ALLOWED_ALPHABET" :value="toAlphabetIndex(letter)">{{letter.toUpperCase()}}</option>
        </select>
      </span>
